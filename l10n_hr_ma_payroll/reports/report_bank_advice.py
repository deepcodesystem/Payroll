...
class payroll_advice_report(models.AbstractModel):
    _name = 'report.l10n_hr_ma_payroll.report_bank_advice'
    _description = "Moroccan Bank Advice Report for payroll"
    ...
    def get_detail(self, line_ids):
        ...
        for l in line_ids:
            ...
            res.update({
                    ...
                    'acc_no': l.account_number.acc_number,
                    'bysal': l.bysal,
    ...
    def _get_report_values(self, docids, data=None):
        advice = self.env['hr.bank.advice'].browse(docids)
        return {
            'doc_ids': docids,
            'doc_model': 'hr.bank.advice',
            'data': data,
            'docs': advice,
            'time': time,
